...
<TABLE width=400>
  ...
  <TR>
    ...
    <TD width=400 id=L_default_10><B>Technical Information (for support personnel)</B> 
      <UL class=adminList>
        <LI id=L_default_11>Error Code: 403 Forbidden. The ISA Server denied the specified Uniform Resource Locator (URL). (12202)
<LI id=L_default_12>IP Address: 69.89.17.8
<LI id=L_default_13>Date: 25/05/2012 12:51:17 [GMT]
<LI id=L_default_14>Server: cameurisa01c.EUROPE.ROOT.PRI
